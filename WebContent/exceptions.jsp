<%@ page language="java" import="de.csw.fub.*, org.dom4j.Element, java.util.*"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="left"><strong>Exceptions at run time</strong>:    </div></td>
  </tr>
</table></td>
  </tr>
<tr>
...
<table width="100%" height="77" border="0" align="center" cellpadding="3"
				...
				<tr class="table-wei3">
				  ...
				  <td  width="67" class="downline-gud1"><div align="center"><strong>Workflow </strong></div></td>
				...
				List list = wm.getExceptions();
								...
								for (int i = 0; i < list.size(); i++) {
									...
									String temp;
			temp = wm.formatXml(exceptionElement.elementText("payload"));						
		...
		temp = temp.replaceAll(">", "&gt;");
							...
							<tr>
							  ...
							  <td height="38" class="downline-gud1"><div align="center"><%=exceptionElement.elementText("sender")%></div></td>
							  ...
							  <td class="downline-gud1"><div align="center"><img src="payload.jpg" alt='<%=temp%>' width="20"></div></td>
							</tr>
