...
<body>
	...
	<table width="1011" border="0" align="center" cellpadding="0"
			...
			<td width="746" valign="top">
				<form name="form1" method="post" action="rruleml.jsp">
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
							<td width="82%" height="20" valign="middle">&nbsp;<strong><span
									class="STYLE21">Available workflows</span>:&nbsp;&nbsp; </strong> <select
								name="workflow" class="input1" ONCHANGE="createHtml()">
									<option selected>Please select a workflow</option>
									<%
		...
		<tr>
			<td height="90" colspan="2"><div align="center" class="STYLE21">Supported
