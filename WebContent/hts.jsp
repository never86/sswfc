	...
	<form name="form1" method="post">
		<table width="1011" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<br>
				<br></td>
				<td width="746" align="center" valign="top"><br> <br>
							...
							<td><strong>Human Task Classification</strong>:
								...
								ONCHANGE="changeOption(this)">
									<%
										...
										String[] options = { "All tasks", "Completed tasks",
												"Incompleted tasks", "All exceptions", "Solved Exceptions",
												"Pending Exceptions", "Human tasks",
												"Completed human tasks", "Incompleted human tasks" };
					...
					<table width="98%" border="0" align="center" cellpadding="3"
						...
						<%
							...
							case 0:
								...
								break;
							case 1:
								list = ha.getAllCompletedTasks();
								break;
							case 2:
								list = ha.getAllIncompletedTasks();
								break;
							case 3:
								list = ha.getAllExceptions();
								break;
							case 4:
								list = ha.getSolvedExceptions();
								break;
							case 5:
								list = ha.getUnsolvedExceptions();
								break;
							case 6:
								list = ha.getAllHumanTasks();
								break;
							case 7:
								list = ha.getCompletedHumanTasks();
								break;
							case 8:
								list = ha.getIncompletedHumanTasks();
								break;
							default:
								list = ha.getAllTasks();
								break;
